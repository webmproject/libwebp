...
// Allocates storage for entire file 'file_name_in' and returns contents and
// size in 'data' and 'data_size'. Returns 1 on success, 0 otherwise. '*data'
// should be deleted using free().
...
// If 'file_name_in' is NULL or equal to "-", input is read from stdin by
// calling the function ImgIoUtilReadFromStdin().
...
// Write a data segment into a file named 'file_name_out'. Returns true if ok.
// If 'file_name_out' is NULL or equal to "-", output is written to stdout.
