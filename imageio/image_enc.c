...
int WebPWritePGM(FILE* fout, const WebPDecBuffer* const buffer) {
  return WritePGMOrYUV(fout, buffer, PGM);
}

int WebPWriteYUV(FILE* fout, const WebPDecBuffer* const buffer) {
  return WritePGMOrYUV(fout, buffer, YUV);
}

int WebPWriteRawYUV(FILE* fout, const WebPDecBuffer* const buffer) {
  return WritePGMOrYUV(fout, buffer, RAW_YUV);
}
