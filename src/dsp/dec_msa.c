...
static void TM16(uint8_t* dst) {
  int j;
  v8i16 d1, d2, L0, L1, L2, L3, r0, r1, r2, r3, r4, r5, r6, r7;
  v16i8 t0, t1, t2, t3;
  const v16i8 zero = { 0 };
  ...
  for (j = 0; j < 16; j += 4) {
    L0 = (v8i16)__msa_fill_h(dst[-1 + 0 * BPS]);
    L1 = (v8i16)__msa_fill_h(dst[-1 + 1 * BPS]);
    L2 = (v8i16)__msa_fill_h(dst[-1 + 2 * BPS]);
    L3 = (v8i16)__msa_fill_h(dst[-1 + 3 * BPS]);
...
static void HE16(uint8_t* dst) {   // horizontal
  ...
  for (j = 16; j > 0; j -= 4) {
    L0 = (v16u8)__msa_fill_b(dst[-1 + 0 * BPS]);
    L1 = (v16u8)__msa_fill_b(dst[-1 + 1 * BPS]);
    L2 = (v16u8)__msa_fill_b(dst[-1 + 2 * BPS]);
    L3 = (v16u8)__msa_fill_b(dst[-1 + 3 * BPS]);
