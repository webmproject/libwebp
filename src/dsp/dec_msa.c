...
#define IDCT_1D_W(in0, in1, in2, in3, out0, out1, out2, out3) {  \
  ...
  v4i32 cospi8sqrt2minus1, sinpi8sqrt2;                          \
                                                                 \
  cospi8sqrt2minus1 = __msa_fill_w(20091);                       \
  sinpi8sqrt2 = __msa_fill_w(35468);                             \
  a1_m = in0 + in2;                                              \
  b1_m = in0 - in2;                                              \
...
static void TransformWHT(const int16_t* in, int16_t* out) {
  v8i16 input0, input1;
  v8i16 mask0 = { 0, 1, 2, 3, 8, 9, 10, 11 };
  v8i16 mask1 = { 4, 5, 6, 7, 12, 13, 14, 15 };
  v8i16 mask2 = { 0, 4, 8, 12, 1, 5, 9, 13 };
  v8i16 mask3 = { 3, 7, 11, 15, 2, 6, 10, 14 };
