...
#define LPF_FILTER4_4W(p1_in_out, p0_in_out, q0_in_out, q1_in_out,       \
                       mask_in, hev_in) do {                             \
  v16i8 p1_m, p0_m, q0_m, q1_m, q0_sub_p0, filt_sign;                    \
  v16i8 filt, filt1, filt2;                                              \
  const v16i8 cnst4b = __msa_ldi_b(4);                                   \
  const v16i8 cnst3b = __msa_ldi_b(3);                                   \
  const v16i8 cnst3h = (v16i8)__msa_ldi_h(3);                            \
  ...
  temp0 = __msa_ilvr_b(q0_sub_p0, q0_sub_p0);                            \
  q0_sub_p0_r = __msa_dotp_s_h(temp0, cnst3h);                           \
  filt_r = (v8i16)__msa_ilvr_b(filt_sign, filt);                         \
  filt_r += q0_sub_p0_r;                                                 \
  filt_r = __msa_sat_s_h(filt_r, 7);                                     \
  temp1 = __msa_ilvl_b(q0_sub_p0, q0_sub_p0);                            \
  q0_sub_p0_l = __msa_dotp_s_h(temp1, cnst3h);                           \
  ...
  hev_in = __msa_xori_b(hev_in, 0xff);                                   \
  filt = filt & hev_in;                                                  \
