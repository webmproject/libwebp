...
static WEBP_INLINE void VP8PlanarTo24b_SSE41(
  ...
  // Process R.
  {
    const __m128i shuff0 = _mm_set_epi8(
        5, 128, 128, 4, 128, 128, 3, 128, 128, 2, 128, 128, 1, 128, 128, 0);
    const __m128i shuff1 = _mm_set_epi8(
        128, 10, 128, 128, 9, 128, 128, 8, 128, 128, 7, 128, 128, 6, 128, 128);
    const __m128i shuff2 = _mm_set_epi8(
     128, 128, 15, 128, 128, 14, 128, 128, 13, 128, 128, 12, 128, 128, 11, 128);
  ...
  // Process G.
  {
    ...
    // padding.
    const __m128i shuff0 = _mm_set_epi8(
        128, 128, 4, 128, 128, 3, 128, 128, 2, 128, 128, 1, 128, 128, 0, 128);
    const __m128i shuff1 = _mm_set_epi8(
        10, 128, 128, 9, 128, 128, 8, 128, 128, 7, 128, 128, 6, 128, 128, 5);
    const __m128i shuff2 = _mm_set_epi8(
     128, 15, 128, 128, 14, 128, 128, 13, 128, 128, 12, 128, 128, 11, 128, 128);
  ...
  {
    const __m128i shuff0 = _mm_set_epi8(
        128, 4, 128, 128, 3, 128, 128, 2, 128, 128, 1, 128, 128, 0, 128, 128);
    const __m128i shuff1 = _mm_set_epi8(
        128, 128, 9, 128, 128, 8, 128, 128, 7, 128, 128, 6, 128, 128, 5, 128);
    const __m128i shuff2 = _mm_set_epi8(
      15, 128, 128, 14, 128, 128, 13, 128, 128, 12, 128, 128, 11, 128, 128, 10);
