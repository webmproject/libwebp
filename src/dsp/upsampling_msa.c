...
static void YuvToRgbLine(const uint8_t* y, const uint8_t* u,
  ...
  if (length > 8) {
    uint8_t temp[48];
    memcpy(&temp[0], y, length * sizeof(uint8_t));
    CALC_RGB16(&temp[0], u, v, R, G, B);
    STORE16_3(R, G, B, &temp[0]);
    memcpy(dst, &temp[0], length * 3 * sizeof(*dst));
  } else if (length > 0) {
    uint8_t temp[24];
    memcpy(&temp[0], y, length * sizeof(uint8_t));
    CALC_RGB8(&temp[0], u, v, R, G, B);
    STORE8_3(R, G, B, &temp[0]);
    memcpy(dst, &temp[0], length * 3 * sizeof(*dst));
  }
}
...
static void YuvToBgrLine(const uint8_t* y, const uint8_t* u,
  ...
  if (length > 8) {
    ...
    memcpy(&temp[0], y, length * sizeof(uint8_t));
    CALC_RGB16(&temp[0], u, v, R, G, B);
    STORE16_3(B, G, R, &temp[0]);
    memcpy(dst, &temp[0], length * 3 * sizeof(*dst));
  } else if (length > 0) {
    uint8_t temp[24];
    memcpy(&temp[0], y, length * sizeof(uint8_t));
    CALC_RGB8(&temp[0], u, v, R, G, B);
    STORE8_3(B, G, R, &temp[0]);
    memcpy(dst, &temp[0], length * 3 * sizeof(*dst));
  }
}
...
static void YuvToRgbaLine(const uint8_t* y, const uint8_t* u,
  ...
  if (length > 8) {
    ...
    memcpy(&temp[0], y, length * sizeof(uint8_t));
    CALC_RGB16(&temp[0], u, v, R, G, B);
    STORE16_4(R, G, B, A, &temp[0]);
    memcpy(dst, &temp[0], length * 4 * sizeof(*dst));
  } else if (length > 0) {
    uint8_t temp[32];
    memcpy(&temp[0], y, length * sizeof(uint8_t));
    CALC_RGB8(&temp[0], u, v, R, G, B);
    STORE8_4(R, G, B, A, &temp[0]);
    memcpy(dst, &temp[0], length * 4 * sizeof(*dst));
  }
}
...
static void YuvToBgraLine(const uint8_t* y, const uint8_t* u,
  ...
  if (length > 8) {
    ...
    memcpy(&temp[0], y, length * sizeof(uint8_t));
    CALC_RGB16(&temp[0], u, v, R, G, B);
    STORE16_4(B, G, R, A, &temp[0]);
    memcpy(dst, &temp[0], length * 4 * sizeof(*dst));
  } else if (length > 0) {
    uint8_t temp[32];
    memcpy(&temp[0], y, length * sizeof(uint8_t));
    CALC_RGB8(&temp[0], u, v, R, G, B);
    STORE8_4(B, G, R, A, &temp[0]);
    memcpy(dst, &temp[0], length * 4 * sizeof(*dst));
  }
}
...
static void YuvToArgbLine(const uint8_t* y, const uint8_t* u,
  ...
  if (length > 8) {
    ...
    memcpy(&temp[0], y, length * sizeof(uint8_t));
    CALC_RGB16(&temp[0], u, v, R, G, B);
    STORE16_4(A, R, G, B, &temp[0]);
    memcpy(dst, &temp[0], length * 4 * sizeof(*dst));
  } else if (length > 0) {
    uint8_t temp[32];
    memcpy(&temp[0], y, length * sizeof(uint8_t));
    CALC_RGB8(&temp[0], u, v, R, G, B);
    STORE8_4(A, R, G, B, &temp[0]);
    memcpy(dst, &temp[0], length * 4 * sizeof(*dst));
  }
}
...
static void YuvToRgba4444Line(const uint8_t* y, const uint8_t* u,
  ...
  if (length > 8) {
    ...
    memcpy(&temp[0], y, length * sizeof(uint8_t));
  #ifdef WEBP_SWAP_16BIT_CSP
    CALC_RGBA4444(&temp[0], u, v, BA, RG, 16, &temp[0]);
  #else
    CALC_RGBA4444(&temp[0], u, v, RG, BA, 16, &temp[0]);
  #endif
    memcpy(dst, &temp[0], length * 2 * sizeof(*dst));
  } else if (length > 0) {
    uint8_t temp[16];
    memcpy(&temp[0], y, length * sizeof(uint8_t));
  #ifdef WEBP_SWAP_16BIT_CSP
    CALC_RGBA4444(&temp[0], u, v, BA, RG, 8, &temp[0]);
  #else
    CALC_RGBA4444(&temp[0], u, v, RG, BA, 8, &temp[0]);
  #endif
    memcpy(dst, &temp[0], length * 2 * sizeof(*dst));
  }
}
...
static void YuvToRgb565Line(const uint8_t* y, const uint8_t* u,
  ...
  if (length > 8) {
    ...
    memcpy(&temp[0], y, length * sizeof(uint8_t));
  #ifdef WEBP_SWAP_16BIT_CSP
    CALC_RGB565(&temp[0], u, v, GB, RG, 16, &temp[0]);
  #else
    CALC_RGB565(&temp[0], u, v, RG, GB, 16, &temp[0]);
  #endif
    memcpy(dst, &temp[0], length * 2 * sizeof(*dst));
  } else if (length > 0) {
    uint8_t temp[16];
    memcpy(&temp[0], y, length * sizeof(uint8_t));
  #ifdef WEBP_SWAP_16BIT_CSP
    CALC_RGB565(&temp[0], u, v, GB, RG, 8, &temp[0]);
  #else
    CALC_RGB565(&temp[0], u, v, RG, GB, 8, &temp[0]);
  #endif
    memcpy(dst, &temp[0], length * 2 * sizeof(*dst));
  }
}
