...
static void ConvertRGBToFFRGB_C(const uint8_t* r, const uint8_t* g,
...
void (*WebPConvertRGBToFFRGB)(const uint8_t* r, const uint8_t* g,
                              const uint8_t* b, int len, int step,
                              uint32_t* out);
...
WEBP_TSAN_IGNORE_FUNCTION void WebPInitAlphaProcessing(void) {
  ...
  WebPConvertRGBToFFRGB = ConvertRGBToFFRGB_C;
