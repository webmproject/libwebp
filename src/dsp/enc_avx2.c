...
#define IDX(n) (2 * (n) + 0) & 0x0f, (2 * (n) + 1) & 0x0f
static const uint8_t kZigzag_AVX2[32] = {
  IDX(0),  IDX(1),  IDX(4),  IDX(7) /*!*/, IDX(5),  IDX(2),  IDX(3), IDX(6),
  IDX(9), IDX(12), IDX(13), IDX(10), IDX(8) /*!*/, IDX(11), IDX(14), IDX(15)
};
#undef IDX
...
static WEBP_INLINE int DoQuantizeBlock_AVX2(int16_t in[16], int16_t out[16],
  ...
  const __m256i zigzag = LOAD256U(kZigzag_AVX2);
