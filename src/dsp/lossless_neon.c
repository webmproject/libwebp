...
static WEBP_INLINE uint32_t ClampedAddSubtractHalf(uint32_t c0, uint32_t c1,
                                                   uint32_t c2) {
  const int16x8_t C0 =
      vreinterpret_s16_u16(vmovl_u8(vreinterpret_u8_u32(vld1_dup_u32(&c0))));
  const int16x8_t C1 =
      vreinterpret_s16_u16(vmovl_u8(vreinterpret_u8_u32(vld1_dup_u32(&c1))));
  const int16x8_t C2 =
      vreinterpret_s16_u16(vmovl_u8(vreinterpret_u8_u32(vld1_dup_u32(&c2))));
  // Average.
