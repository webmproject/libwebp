...
static WEBP_INLINE uint32_t Average3(uint32_t a0, uint32_t a1, uint32_t a2) {
  ...
  const uint8x8_t avg0 = vhadd_u32(A0, A2);
  const uint8x8_t A1 = vreinterpret_u8_u32(vld1_dup_u32(&a1));
  const uint32x2_t avg1 = vreinterpret_u32_u8(vhadd_u32(avg0, A1));
...
static WEBP_INLINE uint32_t Average4(uint32_t a0, uint32_t a1,
  ...
  const uint8x8_t A0 = vreinterpret_u8_u32(vld1_dup_u32(&a0));
  const uint8x8_t A1 = vreinterpret_u8_u32(vld1_dup_u32(&a1));
  const uint8x8_t avg0 = vhadd_u32(A0, A1);
  const uint8x8_t A2 = vreinterpret_u8_u32(vld1_dup_u32(&a2));
  const uint8x8_t A3 = vreinterpret_u8_u32(vld1_dup_u32(&a3));
  const uint8x8_t avg1 = vhadd_u32(A2, A3);
  const uint32x2_t avg2 = vreinterpret_u32_u8(vhadd_u32(avg0, avg1));
