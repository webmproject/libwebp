...
static WEBP_INLINE uint32_t ClampedAddSubtractHalf(uint32_t c0, uint32_t c1,
  ...
  const int16x8_t C2 =
      vreinterpretq_s16_u16(vmovl_u8(vreinterpret_u8_u32(vdup_n_u32(c2))));
...
static WEBP_INLINE uint32_t Average3(uint32_t a0, uint32_t a1, uint32_t a2) {
  const uint8x8_t A0 = vreinterpret_u8_u32(vdup_n_u32(a0));
  const uint8x8_t A2 = vreinterpret_u8_u32(vdup_n_u32(a2));
...
static WEBP_INLINE uint32_t Average4(uint32_t a0, uint32_t a1,
  ...
  const uint8x8_t A2 = vreinterpret_u8_u32(vdup_n_u32(a2));
  const uint8x8_t A3 = vreinterpret_u8_u32(vdup_n_u32(a3));
