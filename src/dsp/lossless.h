...
typedef void (*VP8LPredictorResidualBatchFunc)(const uint32_t* in,
                                               const uint32_t* upper,
                                               int num_pixels, uint32_t* out);
extern VP8LPredictorResidualBatchFunc VP8LPredictorsBatch[16];
extern VP8LPredictorResidualBatchFunc VP8LResidualsBatch[16];
