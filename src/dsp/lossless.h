...
typedef void (*VP8LPredictorAddSubBatchFunc)(const uint32_t* in,
                                             const uint32_t* upper,
                                             int num_pixels, uint32_t* out);
extern VP8LPredictorAddSubBatchFunc VP8LPredictorsAdd[16];
...
extern VP8LPredictorAddSubBatchFunc VP8LPredictorsSub[16];
