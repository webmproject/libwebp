...
#define ADD_FOR1(X, ARG, LEN) do {                                             \
  if (a->is_empty_[X]) {                                                       \
    ...
    for (i = 0; i < LEN; ++i) out->ARG[i] = a->ARG[i] + b->ARG[i];             \
  }                                                                            \
} while (0)
...
#define ADD_FOR2(X, ARG, LEN) do {                                             \
  if (a->is_empty_[X]) {                                                       \
    ...
    for (i = 0; i < LEN; ++i) out->ARG[i] += a->ARG[i];                        \
  }                                                                            \
} while (0)
...
static void HistogramAdd_C(const VP8LHistogram* const a,
  ...
  if (b != out) {
    ...
    if (a->is_empty_[1] || a->is_empty_[2] || a->is_empty_[3] ||
        b->is_empty_[1] || b->is_empty_[2] || b->is_empty_[3]) {
