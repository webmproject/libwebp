...
extern int DistanceToPlaneCode(int xsize, int dist);
...
extern void ClearBackwardRefs(VP8LBackwardRefs* const refs);
...
extern void BackwardRefsCursorAdd(VP8LBackwardRefs* const refs,
                                  const PixOrCopy v);
...
extern int HashChainFindOffset(const VP8LHashChain* const p,
                               const int base_position);
WEBP_INLINE int HashChainFindOffset(const VP8LHashChain* const p,
                                           const int base_position) {
...
extern void HashChainFindCopy(const VP8LHashChain* const p, int base_position,
                              int* const offset_ptr, int* const length_ptr);
WEBP_INLINE void HashChainFindCopy(const VP8LHashChain* const p,
                                   int base_position, int* const offset_ptr,
...
extern int BackwardReferencesTraceBackwards(
