...
WEBP_TSAN_IGNORE_FUNCTION static void InitGammaTables(void) {
  if (!kGammaTablesOk) {
    int v;
...
WEBP_TSAN_IGNORE_FUNCTION static void InitGammaTablesS(void) {
