...
// -----------------------------------------------------------------------------
//
// Decodes an animated WebP file and dump the decoded frames as PNG or TIFF.
//
...
static void Help(void) {
  printf("Usage: anim_dump files... [options]\n");
  printf("\nOptions:\n");
  printf("  -folder <string> .... dump folder\n");
  printf("  -prefix <string> .... prefix for dumped frames (default: dump_)\n");
