...
rm -rf ${BUILDDIR} ${TARGETDIR} ${DECTARGETDIR} ${MUXTARGETDIR} ${DEMUXTARGETDIR}
mkdir -p ${BUILDDIR} ${TARGETDIR}/Headers/ ${DECTARGETDIR}/Headers/ ${MUXTARGETDIR}/Headers/ ${DEMUXTARGETDIR}/Headers/
...
cp -a ${SRCDIR}/src/webp/{decode,encode,types,mux,mux_types}.h ${MUXTARGETDIR}/Headers/
${LIPO} -create ${MUXLIBLIST} -output ${MUXTARGETDIR}/WebPMux

echo "DEMUXLIBLIST = ${DEMUXLIBLIST}"
cp -a ${SRCDIR}/src/webp/{decode,encode,types,mux_types,demux}.h ${DEMUXTARGETDIR}/Headers/
